...
Omfatter ogs&#229; sport- og idrettsomr&#229;der i tilknytning til skoler, omr&#229;der tilrettelagt for frisbeegolf, putball/fotballgolf og motorsport (for eksempel motorcrossbane), samt ridesportsanlegg og travbaner.
...
image::figurer/idrettsplass2_frisbeegolf.png[link=figurer/idrettsplass2_frisbeegolf.png, Alt="Illustrasjon av hvordan områder for frisbeegolf skal registreres"]
 
 
'''
.Illustrasjon av hvordan områder for putball/fotballgolf skal registreres  
image::figurer/idrettsplass3_putball.png[link=figurer/idrettsplass3_putball.png, Alt="Illustrasjon av hvordan områder for putball/fotballgolf skal registreres"]
 
 
'''
.Illustrasjon av hvordan områder for ridesport skal registreres. Oftest grusunderlag med hinder
image::figurer/idrettsplass4_ridesport.png[link=figurer/idrettsplass4_ridesport.png, Alt="Illustrasjon av hvordan områder for ridesport skal registreres. Oftest grusunderlag med hinder"]
 
 
'''
.Illustrasjon av hvordan områder for travsport skal registreres
image::figurer/idrettsplass5_travbane.png[link=figurer/idrettsplass5_travbane.png, Alt="Illustrasjon av hvordan områder for travsport skal registreres"]
